if (typeof Webshipper === typeof undefined) {
	Webshipper = {};
}

(function ($) {

	Webshipper.UI = Garnish.Base.extend({
		init: function () {
			var $tabsContainer = $('[data-vui-tabs]');

			if ($tabsContainer) {
				new Webshipper.UI.SimpleTabs($tabsContainer);
			}
		},
	});

	Webshipper.UI.SimpleTabs = Garnish.Base.extend({
